...
namespace TaskFlow.Application.Features.WorkManagement.Projects.Queries.GetProjectById
{
    public sealed record GetProjectByIdQuery(
        int ProjectId
    ) : IRequest<ProjectDto>, IProjectScopedRequest;
            ...
            CancellationToken cancellationToken)
        {
            ...
            const string sql = """
                SELECT
                    ...
                    p."ProblemStatement"       AS "ProblemStatement",
                    p."BudgetAmount"           AS "BudgetAmount",
                    p."BudgetCurrency"         AS "BudgetCurrency",
                    p."ApproximateDurationWeeks" AS "ApproximateDurationWeeks",
